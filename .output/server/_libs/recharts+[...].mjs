...
var appendOffsetOfLegend = function appendOffsetOfLegend(offset, _unused, props, legendBox) {
	...
	if (legendProps) {
		...
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$30(_objectSpread$30({}, offset), {}, _defineProperty$33({}, align, offset[align] + (boxWidth || 0)));
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$30(_objectSpread$30({}, offset), {}, _defineProperty$33({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
	}
	return offset;
};
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId(data, _items, numericAxisId, cateAxisId, offsetType, reverseStackOrder) {
	...
	var stackGroups = (reverseStackOrder ? _items.reverse() : _items).reduce(function(result, item) {
		...
		return _objectSpread$30(_objectSpread$30({}, result), {}, _defineProperty$33({}, axisId, parentGroup));
	}, {});
	return Object.keys(stackGroups).reduce(function(result, axisId) {
		var group = stackGroups[axisId];
		if (group.hasStack) group.stackGroups = Object.keys(group.stackGroups).reduce(function(res, stackId) {
			var g = group.stackGroups[stackId];
			return _objectSpread$30(_objectSpread$30({}, res), {}, _defineProperty$33({}, stackId, {
				numericAxisId,
				cateAxisId,
				items: g.items,
		...
		return _objectSpread$30(_objectSpread$30({}, result), {}, _defineProperty$33({}, axisId, group));
	}, {});
};
/**
...
var formatAxisMap$1 = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return Object.keys(axisMap).reduce(function(result, id) {
		...
		return _objectSpread$29(_objectSpread$29({}, result), {}, _defineProperty$32({}, id, finalAxis));
	}, {});
};
...
var Rectangle = function Rectangle(rectangleProps) {
	var props = _objectSpread$24(_objectSpread$24({}, defaultProps$2), rectangleProps);
...
var PolarAngles = function PolarAngles(props) {
	...
	var polarAnglesProps = _objectSpread$22({ stroke: "#ccc" }, filterProps(props, false));
...
var ConcentricCircle = function ConcentricCircle(props) {
	...
	var concentricCircleProps = _objectSpread$22(_objectSpread$22({ stroke: "#ccc" }, filterProps(props, false)), {}, { fill: "none" });
...
var ConcentricPolygon = function ConcentricPolygon(props) {
	...
	var concentricPolygonProps = _objectSpread$22(_objectSpread$22({ stroke: "#ccc" }, filterProps(props, false)), {}, { fill: "none" });
	...
	return _createClass$16(PolarRadiusAxis, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				var props = _objectSpread$21(_objectSpread$21(_objectSpread$21({}, filterProps(others, false)), {}, { fill: "none" }, filterProps(axisLine, false)), {}, {
					x1: point0.x,
					y1: point0.y,
					x2: point1.x,
					y2: point1.y
		...
		},
		{
			...
			value: function renderTicks() {
				...
				var items = ticks.map(function(entry, i) {
					...
					var tickProps = _objectSpread$21(_objectSpread$21(_objectSpread$21(_objectSpread$21({
						textAnchor,
	...
	return _createClass$15(PolarAngleAxis, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				var props = _objectSpread$20(_objectSpread$20({}, filterProps(this.props, false)), {}, { fill: "none" }, filterProps(axisLine, false));
		...
		},
		{
			...
			value: function renderTicks() {
				...
				var customTickProps = filterProps(tick, false);
				var tickLineProps = _objectSpread$20(_objectSpread$20({}, axisProps), {}, { fill: "none" }, filterProps(tickLine, false));
				var items = ticks.map(function(entry, i) {
					var lineCoord = _this.getTickLineCoord(entry);
					var tickProps = _objectSpread$20(_objectSpread$20(_objectSpread$20({ textAnchor: _this.getTickTextAnchor(entry) }, axisProps), {}, {
						stroke: "none",
						fill: stroke
					}, customTickProps), {}, {
						index: i,
...
var Trapezoid = function Trapezoid(props) {
	var trapezoidProps = _objectSpread$19(_objectSpread$19({}, defaultProps$1), props);
	var pathRef = (0, import_react.useRef)();
...
function typeGuardSectorProps(option, props) {
	...
	return _objectSpread$15(_objectSpread$15(_objectSpread$15({}, props), option), {}, {
		cx,
		cy
	});
}
...
var _excluded2$4 = ["value", "background"];
		...
		},
		{
			...
			value: function renderSectorsStatically(sectors) {
				...
				return sectors.map(function(entry, i) {
					...
					var props = _objectSpread$14(_objectSpread$14(_objectSpread$14(_objectSpread$14({}, baseProps), {}, { cornerRadius: parseCornerRadius(cornerRadius) }, entry), adaptEventsOfChild(_this2.props, entry, i)), {}, {
					...
					return /*#__PURE__*/ import_react.createElement(RadialBarSector, _extends$12({}, props, { key: "sector-".concat(i) }));
				});
			}
		},
		{
			...
			value: function renderSectorsWithAnimation() {
				...
				return /*#__PURE__*/ import_react.createElement(es6_default, {
					...
					var stepData = data.map(function(entry, index) {
						...
						return _objectSpread$14(_objectSpread$14({}, entry), {}, { endAngle: interpolator(t) });
					});
					return /*#__PURE__*/ import_react.createElement(Layer, null, _this3.renderSectorsStatically(stepData));
				});
			}
		...
		},
		{
			...
			value: function renderBackground(sectors) {
				...
				return sectors.map(function(entry, i) {
					...
					var props = _objectSpread$14(_objectSpread$14(_objectSpread$14(_objectSpread$14(_objectSpread$14({ cornerRadius: parseCornerRadius(cornerRadius) }, rest), {}, { fill: "#eee" }, background), backgroundProps), adaptEventsOfChild(_this4.props, entry, i)), {}, {
						index: i,
...
_defineProperty$17(RadialBar, "displayName", "RadialBar");
_defineProperty$17(RadialBar, "defaultProps", {
	angleAxisId: 0,
	radiusAxisId: 0,
	minPointSize: 0,
	hide: false,
...
_defineProperty$17(RadialBar, "getComposedData", function(_ref2) {
	...
	return {
		data: displayedData.map(function(entry, index) {
			...
			return _objectSpread$14(_objectSpread$14(_objectSpread$14(_objectSpread$14({}, entry), backgroundSector), {}, {
				payload: entry,
...
//#endregion
export { ResponsiveContainer as _, LineChart as a, Line as c, RadialBar as d, Radar as f, Cell as g, PolarGrid as h, BarChart as i, CartesianGrid as l, PolarAngleAxis as m, RadarChart as n, YAxis as o, Pie as p, PieChart as r, XAxis as s, RadialBarChart as t, Bar as u, Tooltip as v };
