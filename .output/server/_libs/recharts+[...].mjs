...
var adaptEventsOfChild = function adaptEventsOfChild(props, data, index) {
	if (!(0, import_isObject.default)(props) || _typeof$33(props) !== "object") return null;
	var out = null;
...
var Symbols = function Symbols(_ref) {
	...
	var props = _objectSpread$28(_objectSpread$28({}, _objectWithoutProperties$11(_ref, _excluded$11)), {}, {
		type,
		size,
		sizeType
	});
	...
	return _createClass$14(Legend, [
		...
		},
		{
			...
			value: function render() {
				...
				}, renderContent$1(content, _objectSpread$26(_objectSpread$26({}, this.props), {}, { payload: getUniqPayload(payload, payloadUniqBy, defaultUniqBy$1) })));
			}
		}
	], [{
		key: "getWithHeight",
...
var DefaultTooltipContent = function DefaultTooltipContent(props) {
	...
	var renderContent = function renderContent() {
		if (payload && payload.length) {
			...
			var items = (itemSorter ? (0, import_sortBy.default)(payload, itemSorter) : payload).map(function(entry, i) {
				if (entry.type === "none") return null;
				var finalItemStyle = _objectSpread$25({
					display: "block",
					paddingTop: 4,
					paddingBottom: 4,
	...
	var finalStyle = _objectSpread$25({
		margin: 0,
		padding: 10,
		backgroundColor: "#fff",
	...
	var finalLabelStyle = _objectSpread$25({ margin: 0 }, labelStyle);
...
function getTooltipCSSClassName(_ref) {
	...
	return clsx(CSS_CLASS_PREFIX, _defineProperty$27(_defineProperty$27(_defineProperty$27(_defineProperty$27({}, "".concat(CSS_CLASS_PREFIX, "-right"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX >= coordinate.x), "".concat(CSS_CLASS_PREFIX, "-left"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX < coordinate.x), "".concat(CSS_CLASS_PREFIX, "-bottom"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY >= coordinate.y), "".concat(CSS_CLASS_PREFIX, "-top"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY < coordinate.y));
}
...
var TooltipBoundingBox = /*#__PURE__*/ function(_PureComponent) {
	function TooltipBoundingBox() {
		...
		_defineProperty$26(_this, "state", {
			dismissed: false,
		...
		_defineProperty$26(_this, "handleKeyDown", function(event) {
			if (event.key === "Escape") {
	...
	return _createClass$13(TooltipBoundingBox, [
		...
		},
		{
			...
			value: function render() {
				...
				var outerStyle = _objectSpread$24(_objectSpread$24({ transition: isAnimationActive && active ? "transform ".concat(animationDuration, "ms ").concat(animationEasing) : void 0 }, cssProperties), {}, {
					pointerEvents: "none",
	...
	return _createClass$12(Tooltip, [{
		...
		value: function render() {
			...
			return /*#__PURE__*/ import_react.createElement(TooltipBoundingBox, {
				...
				viewBox,
				wrapperStyle
			}, renderContent(content, _objectSpread$23(_objectSpread$23({}, this.props), {}, { payload: finalPayload })));
		}
	}]);
}(import_react.PureComponent);
_defineProperty$25(Tooltip, "displayName", "Tooltip");
_defineProperty$25(Tooltip, "defaultProps", {
...
var ResponsiveContainer = /*#__PURE__*/ (0, import_react.forwardRef)(function(_ref, ref) {
	...
	var chartContent = (0, import_react.useMemo)(function() {
		...
		return import_react.Children.map(children, function(child) {
			if (/*#__PURE__*/ import_react.isValidElement(child)) return /*#__PURE__*/ (0, import_react.cloneElement)(child, _objectSpread$22({
				width: calculatedWidth,
				height: calculatedHeight
			}, isCharts ? { style: _objectSpread$22({
				height: "100%",
				width: "100%",
	...
	return /*#__PURE__*/ import_react.createElement("div", {
		...
		style: _objectSpread$22(_objectSpread$22({}, style), {}, {
			width,
			height,
			minWidth,
			minHeight,
...
function removeInvalidKeys(obj) {
	var copyObj = _objectSpread$21({}, obj);
...
var getStringSize = function getStringSize(text) {
	...
	try {
		...
		var measurementSpanStyle = _objectSpread$21(_objectSpread$21({}, SPAN_STYLE), copyStyle);
...
_defineProperty$22(ErrorBar, "defaultProps", {
	stroke: "black",
	strokeWidth: 1.5,
	width: 5,
	offset: 0,
...
_defineProperty$22(ErrorBar, "displayName", "ErrorBar");
//#endregion
...
var getLegendProps = function getLegendProps(_ref) {
	...
	var legendProps = legendDefaultProps !== void 0 ? _objectSpread$20(_objectSpread$20({}, legendDefaultProps), legendItem.props) : {};
	var legendData;
	if (legendItem.props && legendItem.props.payload) legendData = legendItem.props && legendItem.props.payload;
		...
		var itemProps = itemDefaultProps !== void 0 ? _objectSpread$20(_objectSpread$20({}, itemDefaultProps), item.props) : {};
	...
	return _objectSpread$20(_objectSpread$20(_objectSpread$20({}, legendProps), Legend.getWithHeight(legendItem, legendWidth)), {}, {
		payload: legendData,
		item: legendItem
	});
};
...
var getMainColorOfGraphicItem = function getMainColorOfGraphicItem(item) {
	...
	var defaultedProps = (_item$type = item.type) !== null && _item$type !== void 0 && _item$type.defaultProps ? _objectSpread$19(_objectSpread$19({}, item.type.defaultProps), item.props) : item.props;
	...
	for (var i = 0, len = numericAxisIds.length; i < len; i++) {
		...
		for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
			...
			if (barItems && barItems.length) {
				...
				var barItemProps = barItemDefaultProps !== void 0 ? _objectSpread$19(_objectSpread$19({}, barItemDefaultProps), barItems[0].props) : barItems[0].props;
...
var appendOffsetOfLegend = function appendOffsetOfLegend(offset, _unused, props, legendBox) {
	...
	if (legendProps) {
		...
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$19(_objectSpread$19({}, offset), {}, _defineProperty$20({}, align, offset[align] + (boxWidth || 0)));
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$19(_objectSpread$19({}, offset), {}, _defineProperty$20({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
	}
	return offset;
};
...
var getStackGroupsByAxisId = function getStackGroupsByAxisId(data, _items, numericAxisId, cateAxisId, offsetType, reverseStackOrder) {
	...
	var stackGroups = (reverseStackOrder ? _items.reverse() : _items).reduce(function(result, item) {
		var _item$type2;
		var defaultedProps = (_item$type2 = item.type) !== null && _item$type2 !== void 0 && _item$type2.defaultProps ? _objectSpread$19(_objectSpread$19({}, item.type.defaultProps), item.props) : item.props;
		...
		return _objectSpread$19(_objectSpread$19({}, result), {}, _defineProperty$20({}, axisId, parentGroup));
	}, {});
	return Object.keys(stackGroups).reduce(function(result, axisId) {
		var group = stackGroups[axisId];
		if (group.hasStack) group.stackGroups = Object.keys(group.stackGroups).reduce(function(res, stackId) {
			var g = group.stackGroups[stackId];
			return _objectSpread$19(_objectSpread$19({}, res), {}, _defineProperty$20({}, stackId, {
				numericAxisId,
				cateAxisId,
				items: g.items,
		...
		return _objectSpread$19(_objectSpread$19({}, result), {}, _defineProperty$20({}, axisId, group));
	}, {});
};
/**
...
var getStackedDataOfItem = function getStackedDataOfItem(item, stackGroups) {
	var _item$type3;
	var stackId = ((_item$type3 = item.type) !== null && _item$type3 !== void 0 && _item$type3.defaultProps ? _objectSpread$19(_objectSpread$19({}, item.type.defaultProps), item.props) : item.props).stackId;
	if (isNumOrStr(stackId)) {
...
var getTooltipItem = function getTooltipItem(graphicalItem, payload) {
	var defaultedProps = graphicalItem.type.defaultProps ? _objectSpread$19(_objectSpread$19({}, graphicalItem.type.defaultProps), graphicalItem.props) : graphicalItem.props;
	...
	return _objectSpread$19(_objectSpread$19({}, filterProps(graphicalItem, false)), {}, {
		dataKey,
		unit,
		formatter,
		name: name || dataKey,
...
var formatAxisMap = function formatAxisMap(props, axisMap, offset, axisType, chartName) {
	...
	return Object.keys(axisMap).reduce(function(result, id) {
		...
		if ((0, import_isNil.default)(axis.range)) {
			...
			range = axis.range;
			var _range2 = _slicedToArray$3(range, 2);
		...
		var ticks = getTicksOfScale(scale, _objectSpread$18(_objectSpread$18({}, axis), {}, { realScaleType }));
		var finalAxis = _objectSpread$18(_objectSpread$18(_objectSpread$18({}, axis), ticks), {}, {
			range,
			radius: outerRadius,
			realScaleType,
			scale,
		...
		return _objectSpread$18(_objectSpread$18({}, result), {}, _defineProperty$19({}, id, finalAxis));
	}, {});
};
...
var inRangeOfSector = function inRangeOfSector(_ref5, sector) {
	...
	if (inRange) return _objectSpread$18(_objectSpread$18({}, sector), {}, {
		radius,
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel(props) {
	...
	if (position === "top") return _objectSpread$17(_objectSpread$17({}, {
		x: x + width / 2,
	...
	if (position === "bottom") return _objectSpread$17(_objectSpread$17({}, {
		x: x + width / 2,
	...
	if (position === "left") {
		...
		return _objectSpread$17(_objectSpread$17({}, _attrs2), parentViewBox ? {
	...
	if (position === "right") {
		...
		return _objectSpread$17(_objectSpread$17({}, _attrs3), parentViewBox ? {
	...
	if (position === "insideLeft") return _objectSpread$17({
		x: x + horizontalOffset,
		y: y + height / 2,
		textAnchor: horizontalStart,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideRight") return _objectSpread$17({
		x: x + width - horizontalOffset,
		y: y + height / 2,
		textAnchor: horizontalEnd,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideTop") return _objectSpread$17({
		x: x + width / 2,
		y: y + verticalOffset,
		textAnchor: "middle",
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottom") return _objectSpread$17({
		x: x + width / 2,
		y: y + height - verticalOffset,
		textAnchor: "middle",
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideTopLeft") return _objectSpread$17({
		x: x + horizontalOffset,
		y: y + verticalOffset,
		textAnchor: horizontalStart,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideTopRight") return _objectSpread$17({
		x: x + width - horizontalOffset,
		y: y + verticalOffset,
		textAnchor: horizontalEnd,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottomLeft") return _objectSpread$17({
		x: x + horizontalOffset,
		y: y + height - verticalOffset,
		textAnchor: horizontalStart,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideBottomRight") return _objectSpread$17({
		x: x + width - horizontalOffset,
		y: y + height - verticalOffset,
		textAnchor: horizontalEnd,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if ((0, import_isObject.default)(position) && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$17({
...
function Label(_ref4) {
	...
	var props = _objectSpread$17({ offset }, restProps);
...
function LabelList(_ref) {
	...
	return /*#__PURE__*/ import_react.createElement(Layer, { className: "recharts-label-list" }, data.map(function(entry, index) {
		...
		return /*#__PURE__*/ import_react.createElement(Label, _extends$15({}, filterProps(entry, true), others, idProps, {
			...
			value,
			textBreakAll,
			viewBox: Label.parseViewBox((0, import_isNil.default)(clockWise) ? entry : _objectSpread$16(_objectSpread$16({}, entry), {}, { clockWise })),
			key: "label-".concat(index),
			index
		}));
	}));
...
var Sector = function Sector(sectorProps) {
	var props = _objectSpread$15(_objectSpread$15({}, defaultProps$1), sectorProps);
...
var getPath$1 = function getPath(_ref) {
	...
	if (Array.isArray(baseLine)) {
		...
		var areaPoints = formatPoints.map(function(entry, index) {
			return _objectSpread$14(_objectSpread$14({}, entry), {}, { base: formatBaseLine[index] });
		});
...
var Rectangle = function Rectangle(rectangleProps) {
	var props = _objectSpread$13(_objectSpread$13({}, defaultProps), rectangleProps);
...
var PolarAngles = function PolarAngles(props) {
	...
	var polarAnglesProps = _objectSpread$11({ stroke: "#ccc" }, filterProps(props, false));
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid-angle" }, polarAngles.map(function(entry) {
		...
		return /*#__PURE__*/ import_react.createElement("line", _extends$8({}, polarAnglesProps, {
...
var ConcentricCircle = function ConcentricCircle(props) {
	...
	var concentricCircleProps = _objectSpread$11(_objectSpread$11({ stroke: "#ccc" }, filterProps(props, false)), {}, { fill: "none" });
	return /*#__PURE__*/ import_react.createElement("circle", _extends$8({}, concentricCircleProps, {
...
var ConcentricPolygon = function ConcentricPolygon(props) {
	...
	var concentricPolygonProps = _objectSpread$11(_objectSpread$11({ stroke: "#ccc" }, filterProps(props, false)), {}, { fill: "none" });
	return /*#__PURE__*/ import_react.createElement("path", _extends$8({}, concentricPolygonProps, {
...
var ConcentricPath = function ConcentricPath(props) {
	...
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid-concentric" }, polarRadius.map(function(entry, i) {
		var key = i;
		if (gridType === "circle") return /*#__PURE__*/ import_react.createElement(ConcentricCircle, _extends$8({ key }, props, {
			radius: entry,
			index: i
		}));
		return /*#__PURE__*/ import_react.createElement(ConcentricPolygon, _extends$8({ key }, props, {
			radius: entry,
			index: i
		}));
	}));
...
var PolarGrid = function PolarGrid(_ref) {
	...
	return /*#__PURE__*/ import_react.createElement("g", { className: "recharts-polar-grid" }, /*#__PURE__*/ import_react.createElement(PolarAngles, _extends$8({
		cx,
		cy,
		innerRadius,
		outerRadius,
		gridType,
		radialLines
	}, props)), /*#__PURE__*/ import_react.createElement(ConcentricPath, _extends$8({
		cx,
		cy,
		innerRadius,
		outerRadius,
	...
	return _createClass$9(PolarRadiusAxis, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				var props = _objectSpread$10(_objectSpread$10(_objectSpread$10({}, filterProps(others, false)), {}, { fill: "none" }, filterProps(axisLine, false)), {}, {
					x1: point0.x,
					y1: point0.y,
					x2: point1.x,
					y2: point1.y
				});
				return /*#__PURE__*/ import_react.createElement("line", _extends$7({ className: "recharts-polar-radius-axis-line" }, props));
			}
		},
		{
			key: "renderTicks",
		...
		value: function renderTickItem(option, props, value) {
			...
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$7({}, props, { className: "recharts-polar-radius-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.PureComponent);
_defineProperty$11(PolarRadiusAxis, "displayName", "PolarRadiusAxis");
_defineProperty$11(PolarRadiusAxis, "axisType", "radiusAxis");
_defineProperty$11(PolarRadiusAxis, "defaultProps", {
	type: "number",
	radiusAxisId: 0,
	cx: 0,
	cy: 0,
	...
	return _createClass$8(PolarAngleAxis, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				var props = _objectSpread$9(_objectSpread$9({}, filterProps(this.props, false)), {}, { fill: "none" }, filterProps(axisLine, false));
				if (axisLineType === "circle") return /*#__PURE__*/ import_react.createElement(Dot, _extends$6({ className: "recharts-polar-angle-axis-line" }, props, {
					cx,
					cy,
					r: radius
				}));
				...
				return /*#__PURE__*/ import_react.createElement(Polygon, _extends$6({ className: "recharts-polar-angle-axis-line" }, props, { points }));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks() {
				...
				var customTickProps = filterProps(tick, false);
				var tickLineProps = _objectSpread$9(_objectSpread$9({}, axisProps), {}, { fill: "none" }, filterProps(tickLine, false));
				var items = ticks.map(function(entry, i) {
					var lineCoord = _this.getTickLineCoord(entry);
					var tickProps = _objectSpread$9(_objectSpread$9(_objectSpread$9({ textAnchor: _this.getTickTextAnchor(entry) }, axisProps), {}, {
						stroke: "none",
						fill: stroke
					}, customTickProps), {}, {
						index: i,
					...
					return /*#__PURE__*/ import_react.createElement(Layer, _extends$6({
						...
						key: "tick-".concat(entry.coordinate)
					}, adaptEventsOfChild(_this.props, entry, i)), tickLine && /*#__PURE__*/ import_react.createElement("line", _extends$6({ className: "recharts-polar-angle-axis-tick-line" }, tickLineProps, lineCoord)), tick && PolarAngleAxis.renderTickItem(tick, tickProps, tickFormatter ? tickFormatter(entry.value, i) : entry.value));
				});
		...
		value: function renderTickItem(option, props, value) {
			...
			else tickItem = /*#__PURE__*/ import_react.createElement(Text, _extends$6({}, props, { className: "recharts-polar-angle-axis-tick-value" }), value);
			return tickItem;
		}
	}]);
}(import_react.PureComponent);
_defineProperty$10(PolarAngleAxis, "displayName", "PolarAngleAxis");
_defineProperty$10(PolarAngleAxis, "axisType", "angleAxis");
_defineProperty$10(PolarAngleAxis, "defaultProps", {
	type: "category",
	angleAxisId: 0,
	scale: "auto",
	cx: 0,
...
var Radar = /*#__PURE__*/ function(_PureComponent) {
	function Radar() {
		var _this;
		_classCallCheck$7(this, Radar);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _callSuper$5(this, Radar, [].concat(args));
		...
		_defineProperty$9(_this, "handleMouseEnter", function(e) {
			var onMouseEnter = _this.props.onMouseEnter;
			if (onMouseEnter) onMouseEnter(_this.props, e);
		});
		_defineProperty$9(_this, "handleMouseLeave", function(e) {
			var onMouseLeave = _this.props.onMouseLeave;
			if (onMouseLeave) onMouseLeave(_this.props, e);
		});
		return _this;
	}
	_inherits$5(Radar, _PureComponent);
	return _createClass$7(Radar, [
		{
			key: "renderDots",
		...
		},
		{
			...
			value: function renderPolygonStatically(points) {
				...
				var radar;
				if (/*#__PURE__*/ import_react.isValidElement(shape)) radar = /*#__PURE__*/ import_react.cloneElement(shape, _objectSpread$8(_objectSpread$8({}, this.props), {}, { points }));
				else if ((0, import_isFunction.default)(shape)) radar = shape(_objectSpread$8(_objectSpread$8({}, this.props), {}, { points }));
				else radar = /*#__PURE__*/ import_react.createElement(Polygon, _extends$5({}, filterProps(this.props, true), {
		...
		value: function renderDotItem(option, props) {
			...
			if (/*#__PURE__*/ import_react.isValidElement(option)) dotItem = /*#__PURE__*/ import_react.cloneElement(option, props);
				...
				dotItem = /*#__PURE__*/ import_react.createElement(Dot, _extends$5({}, dotProps, {
					key,
...
_defineProperty$9(Radar, "getComposedData", function(_ref2) {
	...
	if (isRange) points.forEach(function(point) {
		if (Array.isArray(point.value)) {
			...
			baseLinePoints.push(_objectSpread$8(_objectSpread$8({}, point), {}, { radius }, polarToCartesian(cx, cy, radius, point.angle)));
...
*/
var RadarChart = function generateCategoricalChart(_ref6) {
...
//#endregion
export { ResponsiveContainer as a, PolarGrid as i, Radar as n, PolarAngleAxis as r, RadarChart as t };
